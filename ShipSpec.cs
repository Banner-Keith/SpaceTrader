...
namespace SpaceTrader
{
    public class ShipSpec : STSerializableObject
    {
        ...
        public Image Image => Game.CurrentGame.ParentWindow.ShipImages.Images[ImageIndex * Consts.ImagesPerShip + Consts.ShipImgOffsetNormal];

        public Image ImageDamaged => Game.CurrentGame.ParentWindow.ShipImages.Images[ImageIndex * Consts.ImagesPerShip + Consts.ShipImgOffsetDamage];

        public Image ImageDamagedWithShields => Game.CurrentGame.ParentWindow.ShipImages.Images[ImageIndex * Consts.ImagesPerShip + Consts.ShipImgOffsetSheildDamage];
        ...
        public Image ImageWithShields => Game.CurrentGame.ParentWindow.ShipImages.Images[ImageIndex * Consts.ImagesPerShip + Consts.ShipImgOffsetShield];

        public TechLevel MinimumTechLevel => _minTech;

        public string Name => Strings.ShipNames[(int)Type];

        public int Occurrence => _occurrence;

        public Activity Police => _police;

        public Activity Pirates => _pirates;
        ...
        public Activity Traders => _traders;
