...
namespace SpaceTrader
{
    public class Functions
    {
        ...
        private const int MaxWord = 65535;

        public static long SeedX { get; set; } = Defseedx;

        public static long SeedY { get; set; } = Defseedy;
        ...
        private static long Rand()
        {
            ...
            SeedX = a * (SeedX & MaxWord) + (SeedX >> 16);
            SeedY = b * (SeedY & MaxWord) + (SeedY >> 16);

            return ((SeedX << 16) + (SeedY & MaxWord));
        }
