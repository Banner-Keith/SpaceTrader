...
namespace SpaceTrader
{
	public class Strings
	{
		...
		/*
				...
				public static string	HighScoreString									= "Your score, calculated from the way you ended the game, your total worth, and the number of days you played, is entered automatically in the high score table when you qualify. You do NOT qualify if you laded a save game while playing the game.";
				...
				public static string	HowToPlayString									= "Space Trader is a strategy game in which the ultimate goal is to make enough cash to buy your own moon, to which you can retire. The most straightforward way to make cash is to trade goods between solar systems, hopefully making a profit. However, you can also decide to become a pirate and rob innocent traders of their wares. You can also earn an income by bounty hunting.\r\n\r\nInformation on the game can be found in the documentation file which comes with it. The Help menu in the game offers basic information, enough to play the game. The menu choice Help Current Screen always gives information on the screen which is currently shown. The rest of the menu choices give a basic overview of the game, of which this particular text is the first. The First Steps choice is especially interesting for a first-time player, since it describes all the steps you need to perform your first days as a trader.\r\n\r\nYou have to change screens often. All main screens are accessible through the menu. Shortcut keys are provided for the major choices, and you are advised to use them. To make that easier, you don't even have to provide the shortcut-stroke: just write the character associated with the menu and it will be activated. The four choices you have to use the most (Buy Cargo, Sell Cargo, Ship Yard and Short Range Chart) have their own shortcut button at the top right corner of every screen. These shortcut functions can be changed from the Shortcuts menu option in the Game menu.\r\n\r\nAt the start of the game you have a small spaceship of the Gnat type, armed with a simple pulse laser, and 1000 credits to start your ventures. While docked, you can buy or sell trade goods; buy or sell equipment for your ship; buy fuel, repairs or even a new ship at the Ship Yard; hire mercenaries; visit the bank to get a loan; get information on your status, the galaxy or nearby solar systems; and activate the warp to another " +
																																"system.\r\n\r\nWhen you have activated the warp, you materialize nearby the target system you selected. The last distance you have to travel on your impulse engines. During that time, you may encounter pirates, police ships, or other traders.";
				...
				public static string	CannotSaveString								= "There was an error trying to create the save game file. This may be due to a lack of system resources.";
				public static string	CannotLoadString								= "No save game file was found to load. You must first create a save game file with the menu choice \"Save game\".";
				...
				public static string	ReallyLoadString								= "Loading a save game will remove your current game from memory and restore an earlier situation.";
				...
				public static string	SingularityString								= "To use the Portable Singularity in the Galactic Chart, select your destination system by tracking it, then Jump by clicking  the \"J\" button. Viola! You will travel through the Singularity and arrive instantaneously at your destination.";
				...
				public static string	ShortcutPrefsString							= "On this page you can set your preferences for the rectangular shortcut buttons used when you're in the dock.\r\n\r\nUse the pull downs to assign the function to each navigation button. Shortcut 1 is the leftmost shortcut, while Shortcut 4 is the rightmost.";
				public static string	SpaceLitteringString						= "Space litterers will at least be considered dubious. If you are already a dubious character, space littering will only add to your list of offenses. However, the police must of course be able to track the litter to you, which they often are not.";
				public static string	SwitchGameString								= "You can play two parallel games of Space Trader on your Palm. You switch between them by using the \"Switch Game\" option. This allows you to try two different styles of game play at the same time (for instance as a pirate and as an honest trader), or two people to play their own Space Trader game on one Palm. It's best to name the Commander in the two games differently, so you can easily recognize which game is loaded.";
